...
@Mai_bOTs.on_message(pyrogram.filters.video)
async def rename_doc(bot, update):
    await bot.send_message(update.chat.id,"What to do?",reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton(text='rename', callback_data='rename')]]), reply_to_message_id=update.message_id)
